...
// Tablespoons
final Measurement tablespoon = Measurement('1', 'tablespoon', 'tbsp', 3);
final Measurement threeQuarterTbsp =
    Measurement('3/4', 'tablespoon', 'tbsp', 2.25);
//final Measurement halfTbsp = Measurement('1/2', 'tablespoon', 'tbsp', 1.5);
